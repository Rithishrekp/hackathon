...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Check if user is a provider and redirect to provider login
            if (data.role === 'provider') {
                setError('Service providers should use the Provider Login. Redirecting...');
            ...
            if (data.role === 'admin') {
                ...
                navigate('/customer'); // Default to customer dashboard
            }
        } catch (err) {
